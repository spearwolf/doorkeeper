...
> NOTE: all tokens generated by the doorkeeper are cryptographically signed. this can be verified using the _public key_. without the (secret) _private key_, it should also not be possible for anyone else to generate valid tokens.
